...
public interface ITransactionExportService
{
    ...
    Task<Stream> GenerateCSV(ICSVFormatService format, string accountId, DateTime startDate, DateTime endDate);
    ICSVFormatService getFormatService(string CSVFormat);
}
